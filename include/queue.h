 ...
 *
 * For details on the use of these macros, see the queue(3) manual pag.
 */
...
#define LIST_INSERT_AFTER(listelm, elm, field)                                                     \
	...
	do {											   \
		...
		if (LIST_NEXT((elm), field) != 0) LIST_NEXT((elm), field)->field.le_prev = &LIST_NEXT((elm), field);   \
 ...
 * Insert the element "elm" at the head of the list named "head".
 S* The "field" name is the link element as above.
 */
